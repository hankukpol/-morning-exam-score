...
type AdminNavLinksProps = {
  items: NavItem[]; // All permitted items (ungrouped)
};
...
export function AdminNavLinks({ items }: AdminNavLinksProps) {
  ...
  // Determine which items/groups to render
  let groupedItems: Record<string, Array<{ label: string; href: string }>> = {};

  if (activeModule === "dashboard") {
    // Show dashboard quick links grouped by module
    ...
    // Filter items by active module, then group by item.group
