        ...
        <div className="printable-grade-report rounded-[28px] border border-ink/10 bg-white p-6 shadow-panel sm:p-8">
          ...
          <div className="border-b-2 border-ink pb-6 text-center">
            <div className="flex items-center justify-center gap-3">
              ...
              <div className="text-left">
                <p className="text-xs font-semibold text-slate">경찰 합격을 향한 최고의 선택</p>
                <p className="text-xl font-bold text-[#1F4D3A]">한국경찰학원</p>
              </div>
            </div>
          ...
          <div className="mt-10 flex flex-wrap items-end justify-between gap-6 border-t border-ink/10 pt-6">
            ...
            <div className="text-right">
              <p className="text-base font-bold text-ink">한국경찰학원</p>
              <p className="mt-0.5 text-xs text-slate">
                대구광역시 중구 중앙대로 390 센트럴엠빌딩
              </p>
              <p className="mt-0.5 text-xs text-slate">Tel. 053-241-0112</p>
              {/* Stamp placeholder */}
