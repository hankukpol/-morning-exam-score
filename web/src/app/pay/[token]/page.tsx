    ...
    <div className="min-h-screen bg-mist">
      ...
      <div className="mx-auto w-full max-w-lg px-4 pb-10 pt-8">
        ...
        <div className="mt-8 text-center text-xs text-slate">
          <p className="font-medium text-ink">한국경찰학원</p>
          <p className="mt-1">대구광역시 중구 중앙대로 390 센트럴엠빌딩</p>
          <p className="mt-0.5">
            <a href="tel:053-241-0112" className="text-ember transition hover:underline">
              053-241-0112
            </a>
            {" · "}
            평일 09~21시 / 주말 09~18시
