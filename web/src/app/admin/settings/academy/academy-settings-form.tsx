...
const BASIC_FIELDS: FieldConfig[] = [
  { key: "name", label: "학원명 *", placeholder: "예: 한국경찰학원" },
  { key: "directorName", label: "원장명", placeholder: "예: 홍길동" },
  { key: "address", label: "주소", placeholder: "예: 대구광역시 중구 중앙대로 390 센트럴엠빌딩" },
  { key: "phone", label: "대표 전화", placeholder: "예: 053-241-0112" },
...
const BANK_FIELDS: FieldConfig[] = [
  ...
  { key: "bankHolder", label: "예금주", placeholder: "예: 한국경찰학원" },
];
