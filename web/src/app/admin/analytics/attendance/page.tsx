...
export default async function AttendanceAnalyticsPage({
  ...
  // AttendType enum values: NORMAL, LIVE, EXCUSED, ABSENT
  ...
  // NORMAL = 정상 출석, LIVE = 라이브 출석, EXCUSED = 사유 결시, ABSENT = 무단 결시
  ...
  return (
    <div className="p-8 sm:p-10">
      ...
      {total === 0 && (
        <div className="mt-8 rounded-[24px] border border-ink/10 bg-white p-10 text-center shadow-panel">
          <p className="text-sm text-slate">
            {year}년 {month}월 출결 데이터가 없습니다.
          </p>
        </div>
      )}
