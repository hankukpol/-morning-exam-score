    ...
    >
      ...
      <div className="flex flex-col items-center gap-3">
        <div className="flex items-center gap-4">
          <p className="text-base font-semibold text-ink">한국경찰학원장</p>
        ...
        <p className="text-sm text-slate">대구광역시 중구 중앙대로 390 센트럴엠빌딩</p>
        <p className="text-sm text-slate">TEL 053-241-0112</p>
      </div>
    </div>
  );
}
