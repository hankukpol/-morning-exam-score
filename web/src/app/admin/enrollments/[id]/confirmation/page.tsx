        ...
        >
          <div className="px-16 py-14">
            ...
            <div className="mb-8 border-b-2 border-[#1F4D3A] pb-4">
              <p className="text-lg font-bold text-[#1F4D3A]">한국경찰학원</p>
              <p className="mt-0.5 text-sm text-[#4B5563]">
                대구광역시 중구 중앙대로 390 센트럴엠빌딩 &nbsp;|&nbsp; TEL 053-241-0112
              </p>
            </div>
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="flex items-center gap-6">
                <div className="text-right">
                  <p className="text-base font-bold text-[#111827]">한국경찰학원</p>
              ...
              <p className="text-xs text-[#4B5563]">TEL 053-241-0112</p>
            </div>
          </div>
        </div>
      </div>
