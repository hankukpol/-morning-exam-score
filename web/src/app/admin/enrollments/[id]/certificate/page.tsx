          ...
          <div className="px-10 py-8">
            ...
            <div className="mt-6 flex items-end justify-between">
              <div className="text-sm text-[#4B5563]">
                <p className="font-semibold text-[#111827]">한국경찰학원</p>
                <p className="mt-1 text-xs">대구광역시 중구 중앙대로 390 센트럴엠빌딩</p>
                <p className="mt-0.5 text-xs">대표전화: 053-241-0112</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <p className="text-sm text-[#4B5563]">한국경찰학원 원장</p>
                <div
