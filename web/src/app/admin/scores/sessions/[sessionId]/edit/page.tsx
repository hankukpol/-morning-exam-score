  ...
  return (
    <div className="p-8 sm:p-10">
      ...
      <p className="mt-1 text-sm text-slate">
        {session.period.name} &middot; {session.week}주차 &middot; {subjectLabel} &middot; {examTypeLabel}
      </p>
      ...
      <div className="mt-6 rounded-[28px] border border-ink/10 bg-mist p-5">
        ...
        <dl className="mt-3 grid gap-x-6 gap-y-2 sm:grid-cols-2 lg:grid-cols-4 text-sm">
          <div>
