      ...
      >
        <div className="px-14 py-14">
          ...
          <div className="mb-3 flex items-center justify-between">
            <span className="text-sm font-semibold text-[#1F4D3A]">한국경찰학원</span>
            <span className="text-xs text-[#4B5563]">TEL 053-241-0112</span>
          </div>
          ...
          <div className="mt-8 flex items-end justify-end gap-8">
            <div className="flex flex-col items-center gap-2">
              <div className="flex items-center gap-3">
                <span className="text-base font-semibold text-[#111827]">한국경찰학원장</span>
              ...
              <p className="text-xs text-[#4B5563]">대구광역시 중구 중앙대로 390 센트럴엠빌딩</p>
            </div>
          </div>
        </div>
      </div>
