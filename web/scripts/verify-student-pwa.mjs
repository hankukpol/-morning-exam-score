...
assert(rootLayout.includes('applicationName: "\\uC544\\uCE68\\uBAA8\\uC758\\uACE0\\uC0AC"'), "Root metadata must expose application name.");
assert(rootLayout.includes('themeColor: "#C55A11"'), "Viewport themeColor must be set.");
...
assert(
  ...
  "Built service worker is missing. Run `npm --prefix web run build` before verify:student-pwa.",
);
